...
_C.SIM.INIT_VIEWER_CAMERA_POSITION = (0.6, 0.0, 0.8)
...
_C.ENV.RENDER_OFFSCREEN = True

_C.ENV.RENDER_DIR = f"datasets/{_C.ENV.PICKED_OBJECT_IDX}"
...
_C.ENV.OFFSCREEN_RENDERER_CAMERA_POSITION = [(0.01, 0.0, 1.0), (0.0, 1.0, 0.0)]
